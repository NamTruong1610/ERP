export const actionLabel = (action) => {
  const map = {
    ...
    TREATMENT_DELETED: 'Deleted a treatment',
    VISIT_CREATED: 'Started a visit',
    VISIT_UPDATED: 'Updated a visit',
    VISIT_CANCELLED: 'Cancelled a visit',
    VISIT_DELETED: 'Deleted a visit',
    VISIT_PROVIDER_ADDED: 'Added a visit provider',
    VISIT_PROVIDER_REMOVED: 'Removed a visit provider',
    TREATMENT_PLAN_CREATED: 'Created a treatment plan',
    TREATMENT_PLAN_UPDATED: 'Updated a treatment plan',
    TREATMENT_PLAN_CANCELLED: 'Cancelled a treatment plan',
    TREATMENT_PLAN_DELETED: 'Deleted a treatment plan',
    TREATMENT_PLAN_ITEM_ADDED: 'Added a treatment plan item',
    TREATMENT_PLAN_ITEM_UPDATED: 'Updated a treatment plan item',
    TREATMENT_PLAN_ITEM_CONVERTED: 'Converted a plan item to a treatment',
    TREATMENT_PLAN_ITEM_CANCELLED: 'Removed a treatment plan item',

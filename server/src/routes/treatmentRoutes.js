...
const {
  ...
  getAllTreatmentsByPatientController,
...
router.get('/patient/:patientId/all', requireAuth, requirePermission(PERMISSIONS.TREATMENTS_READ), getAllTreatmentsByPatientController)

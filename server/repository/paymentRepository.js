...
const { InvoiceItemStatus, InvoiceStatus, PaymentStatus } = require('@prisma/client')
...
exports.createPayment = async (data, itemPayments, client) => {
...
exports.markPaymentVoided = (paymentId, { voidedById, reason }, client = prisma) =>
